# =============================================================================
# intent_parser.py  —  Dataloom v3.0  (Sprint 4A)
#
...
def parse_validation_retry(
    ...
    """
    Fires when validator.py rejects the first intent.
    Sends the question + failed intent + specific errors back to the LLM
    for a targeted correction — without burning an execution attempt.
    """
