...
class TestElseValueValidation:
    ...
    def test_subquery_in_else_value_is_rejected(self):
    ...
    def test_ddl_keyword_in_else_value_is_rejected(self):
    ...
    def test_valid_quoted_string_in_else_value_passes(self):
    ...
    def test_numeric_else_value_passes(self):
    ...
    def test_null_else_value_passes(self):
...
class TestThenValueValidation:
    ...
    def test_subquery_in_then_is_rejected(self):
    ...
    def test_ddl_keyword_in_then_is_rejected(self):
    ...
    def test_bare_column_name_in_then_is_rejected(self):
    ...
    def test_valid_quoted_string_in_then_passes(self):
    ...
    def test_numeric_then_passes(self):
...
class TestConditionKeywordBlocking:
    ...
    def test_select_in_case_when_condition_is_blocked(self):
    ...
    def test_drop_in_case_when_condition_is_blocked(self):
    ...
    def test_sql_comment_in_condition_is_blocked(self):
    ...
    def test_valid_aggregation_condition_passes(self):
