...
def base_intent(schema_map, schema_types, **overrides):
...
def run_test_case(intent, db_type="postgresql", must_contain=None, 
                  must_not_contain=None, count_occurrences=None, 
                  expect_fail=False):
