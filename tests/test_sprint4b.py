...
def val(intent):
    """Validate and return (ok, errors, intent)."""
...
class TestWindowFunctionsRankRegression:
    ...
    def test_order_by_resolves_metric_alias(self):
        q = sql({
            "metrics": [{"metric":"total_revenue","aggregation":"SUM","target_column":"unit_price"}],
            "fact_table": "fact_orders",
            "group_by": ["fact_orders.customer_id"],
    ...
    def test_unknown_function_rejected(self):
        ok, errs = val({
            "metrics": [{"metric":"r","aggregation":"SUM","target_column":"unit_price"}],
            "fact_table": "fact_orders", "group_by": [],
            "window_functions": [{"alias":"x","function":"MEDIAN","partition_by":[],"order_by":"r","order_dir":"DESC"}],
        })
        assert not ok
...
class TestLagLead:
    ...
    def test_lag_target_resolves_to_metric_alias(self):
        q = sql({
            "metrics": [{"metric":"total_revenue","aggregation":"SUM","target_column":"unit_price"}],
            "fact_table": "fact_orders", "group_by": [],
            "window_functions": [{
...
class TestAggregateOver:
    ...
    def test_avg_over_rolling_3month(self):
        q = sql({
            "metrics": [{"metric":"monthly_rev","aggregation":"SUM","target_column":"unit_price"}],
            "fact_table": "fact_orders", "group_by": [],
            "window_functions": [{
    ...
    def test_sum_over_with_partition(self):
        q = sql({
            "metrics": [{"metric":"rev","aggregation":"SUM","target_column":"unit_price"}],
            "fact_table": "fact_orders",
    ...
    def test_range_between_accepted(self):
        ok, errs = val({
            "metrics": [{"metric":"r","aggregation":"SUM","target_column":"unit_price"}],
            "fact_table": "fact_orders", "group_by": [],
            "window_functions": [{
...
class TestSetOperations:
    ...
    def test_intersect_two_sub_intents(self):
        q = sql({
            ...
            "set_operation": {
                "operator": "INTERSECT",
                "left":  {"metrics":[{"metric":"cid","aggregation":"COUNT","target_column":"customer_id"}],"fact_table":"fact_orders","filters":[{"column":"status","operator":"=","value":"shipped"}],"group_by":[]},
                "right": {"metrics":[{"metric":"cid","aggregation":"COUNT","target_column":"customer_id"}],"fact_table":"fact_orders","filters":[{"column":"region","operator":"=","value":"US"}],"group_by":[]},
            },
        })
    ...
    def test_except_two_sub_intents(self):
        q = sql({
            ...
            "set_operation": {
                "operator": "EXCEPT",
                "left":  {"metrics":[{"metric":"cid","aggregation":"COUNT","target_column":"customer_id"}],"fact_table":"fact_orders","group_by":[]},
                "right": {"metrics":[{"metric":"cid","aggregation":"COUNT","target_column":"customer_id"}],"fact_table":"fact_orders","filters":[{"column":"status","operator":"=","value":"cancelled"}],"group_by":[]},
            },
        })
        assert "EXCEPT" in q

    def test_limit_stripped_from_sub_intents(self):
        q = sql({
            "metrics": [{"metric":"r","aggregation":"SUM","target_column":"unit_price"}],
            "fact_table": "fact_orders", "group_by": [],
            "set_operation": {
                "operator": "INTERSECT",
                "left":  {"metrics":[{"metric":"cid","aggregation":"COUNT","target_column":"customer_id"}],"fact_table":"fact_orders","group_by":[],"limit":10},
                "right": {"metrics":[{"metric":"cid","aggregation":"COUNT","target_column":"customer_id"}],"fact_table":"fact_orders","group_by":[],"limit":10},
            },
        })
        # LIMIT should not appear before INTERSECT keyword
    ...
    def test_invalid_operator_rejected(self):
        ok, errs = val({
            ...
            "set_operation": {
                "operator": "MINUS",
                "left":  {"metrics":[{"metric":"cid","aggregation":"COUNT","target_column":"customer_id"}],"fact_table":"fact_orders","group_by":[]},
                "right": {"metrics":[{"metric":"cid","aggregation":"COUNT","target_column":"customer_id"}],"fact_table":"fact_orders","group_by":[]},
            },
        })
        assert not ok
